        ...
        <jsp:include page="../../_search.jsp"></jsp:include>
            <div class="container">
                ...
                <c:set var="pageNum" value="${(page != null) ? page : 1}"/>
                    <th>
                        Id 
                        <a href="${pageContext.request.contextPath}/categoryList?page=${pageNum}&sortBy=idASC"
                        ><i class="fa fa-angle-up"></i></a>
                        <a href="${pageContext.request.contextPath}/categoryList?page=${pageNum}&sortBy=idDESC"
                        ><i class="fa fa-angle-down"></i></a>
                    </th>
                    <th>Name
                        <a href="${pageContext.request.contextPath}/categoryList?page=${pageNum}&sortBy=nameASC"
                        ><i class="fa fa-angle-up"></i></a>
                        <a href="${pageContext.request.contextPath}/categoryList?page=${pageNum}&sortBy=nameDESC"
                        ><i class="fa fa-angle-down"></i></a>                    
                    </th>
                    <th>Description</th>
                    <th>Display (or disable)
                        <a href="${pageContext.request.contextPath}/categoryList?page=${pageNum}&sortBy=disableASC"
                        ><i class="fa fa-angle-up"></i></a>
                        <a href="${pageContext.request.contextPath}/categoryList?page=${pageNum}&sortBy=disableDESC"
                        ><i class="fa fa-angle-down"></i></a>
                    </th>
                    <th>Edit</th>
                </tr>
